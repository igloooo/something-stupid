...
__C.SZO.EVALUATION.THRESHOLD_WEIGHTS = (1, 2, 3, 4, 5, 6,7,8,9) #  (1, 1, 2, 5, 10, 30)  # The corresponding balancing weights
__C.SZO.EVALUATION.THRESHOLDS = (10, 20, 30, 35, 40, 45, 50, 60, 70)  # (0.5, 2, 5, 10, 30)
